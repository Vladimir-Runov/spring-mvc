...
CREATE TABLE prodmag.products (id bigserial PRIMARY KEY, name VARCHAR(128),price INT, details_id bigint, FOREIGN KEY (details_id) REFERENCES prodmag.product_details (id));
